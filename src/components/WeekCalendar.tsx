...
export const CATEGORY_OPTIONS: {
  ...
  },
  {
    ...
    icon: Briefcase,
    swatch: 'bg-red-500',
    bar: 'bg-red-500/20 dark:bg-red-500/30',
  ...
  },
  {
    ...
    bar: 'bg-orange-500/20 dark:bg-orange-500/30',
  ...
  },
  {
    ...
    icon: DollarSign,
    swatch: 'bg-lime-500',
    bar: 'bg-lime-500/20 dark:bg-lime-500/30',
  ...
  },
  {
    ...
    icon: Dumbbell,
    swatch: 'bg-green-500',
    bar: 'bg-green-500/20 dark:bg-green-500/30',
  ...
  },
  {
    ...
    icon: Plane,
    swatch: 'bg-teal-500',
    bar: 'bg-teal-500/20 dark:bg-teal-500/30',
  ...
  },
  {
    ...
    icon: Music,
    swatch: 'bg-cyan-500',
    bar: 'bg-cyan-500/20 dark:bg-cyan-500/30',
  ...
  },
  {
    ...
    icon: GraduationCap,
    swatch: 'bg-sky-500',
    bar: 'bg-sky-500/20 dark:bg-sky-500/30',
  ...
  },
  {
    ...
    bar: 'bg-purple-500/20 dark:bg-purple-500/30',
  ...
  },
  {
    ...
    bar: 'bg-fuchsia-500/20 dark:bg-fuchsia-500/30',
